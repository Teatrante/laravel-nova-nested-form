  ...
  <div class="nested-form">
    ...
    <div class="p-4 border-b border-40 bg-30 flex justify-between items-center"
      ...
      <div class="flex justify-between items-center">
        ...
        <div>
            <a href="javascript:;" @click="reorderResource('up')" class="cursor-pointer text-70 hover:text-primary">
            ...
            <a href="javascript:;" @click="reorderResource('down')" class="cursor-pointer text-70 hover:text-primary mr-3 ">
